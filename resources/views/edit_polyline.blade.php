                ...
                <form method="POST" action="{{ route('polylines.update', $id) }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="geom_polyline" name="geom_polyline" required rows="3"></textarea>
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        map.on('draw:edited', function(e) {
            ...
            layers.eachLayer(function(layer) {
                ...
                var geometry = Terraformer.geojsonToWKT(geojson.geometry);
        ...
        var polyline = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                var geometry = Terraformer.geojsonToWKT(feature.geometry);
